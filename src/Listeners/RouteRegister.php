...
use Notadd\Mall\Controllers\Api\Seller\ProductCategoryController as SellerProductCategoryController;
...
class RouteRegister extends AbstractRouteRegister
{
    ...
    public function handle()
    {
        ...
        $this->router->group(['middleware' => ['auth:api', 'cross', 'web'], 'prefix' => 'api/mall/seller'], function () {
            ...
            $this->router->post('store/dynamic/restore', StoreDynamicController::class . '@restore');
            ...
            $this->router->post('store/product/category', SellerProductCategoryController::class . '@category');
            $this->router->post('store/product/category/list', SellerProductCategoryController::class . '@list');
