...
class RouteRegister extends AbstractRouteRegister
{
    ...
    public function handle()
    {
        $this->router->group(['middleware' => ['auth:api', 'cross', 'web'], 'prefix' => 'api/mall/admin'], function () {
            ...
            $this->router->post('shop/create', AdminStoreController::class . '@create');
            $this->router->post('shop/edit', AdminStoreController::class . '@edit');
            $this->router->post('shop/list', AdminStoreController::class . '@list');
            $this->router->post('shop/remove', AdminStoreController::class . '@remove');
            $this->router->post('shop/restore', AdminStoreController::class . '@restore');
            $this->router->post('shop/category', AdminStoreCategoryController::class . '@category');
            $this->router->post('shop/category/create', AdminStoreCategoryController::class . '@create');
            $this->router->post('shop/category/edit', AdminStoreCategoryController::class . '@edit');
            $this->router->post('shop/category/list', AdminStoreCategoryController::class . '@list');
            $this->router->post('shop/category/remove', AdminStoreCategoryController::class . '@remove');
            $this->router->post('shop/category/restore', AdminStoreCategoryController::class . '@restore');
            $this->router->post('shop/dynamic', AdminStoreDynamicController::class . '@dynamic');
            $this->router->post('shop/dynamic/create', AdminStoreDynamicController::class . '@create');
            $this->router->post('shop/dynamic/edit', AdminStoreDynamicController::class . '@edit');
            $this->router->post('shop/dynamic/list', AdminStoreDynamicController::class . '@dynamic');
            $this->router->post('shop/dynamic/remove', AdminStoreDynamicController::class . '@remove');
