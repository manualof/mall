...
use Notadd\Mall\Controllers\Api\Admin\StoreCategoryController;
use Notadd\Mall\Controllers\Api\Admin\StoreController;
use Notadd\Mall\Controllers\Api\Admin\StoreDynamicController;
...
class RouteRegister extends AbstractRouteRegister
{
    ...
    public function handle()
    {
        $this->router->group(['middleware' => ['auth:api', 'cross', 'web'], 'prefix' => 'api/mall/admin'], function () {
            ...
            $this->router->post('shop/create', StoreController::class . '@create');
            $this->router->post('shop/edit', StoreController::class . '@edit');
            $this->router->post('shop/list', StoreController::class . '@list');
            $this->router->post('shop/remove', StoreController::class . '@remove');
            $this->router->post('shop/restore', StoreController::class . '@restore');
            $this->router->post('shop/category', StoreCategoryController::class . '@category');
            $this->router->post('shop/category/create', StoreCategoryController::class . '@create');
            $this->router->post('shop/category/edit', StoreCategoryController::class . '@edit');
            $this->router->post('shop/category/list', StoreCategoryController::class . '@list');
            $this->router->post('shop/category/remove', StoreCategoryController::class . '@remove');
            $this->router->post('shop/category/restore', StoreCategoryController::class . '@restore');
            $this->router->post('shop/dynamic', StoreDynamicController::class . '@dynamic');
            $this->router->post('shop/dynamic/create', StoreDynamicController::class . '@create');
            $this->router->post('shop/dynamic/edit', StoreDynamicController::class . '@edit');
            $this->router->post('shop/dynamic/list', StoreDynamicController::class . '@dynamic');
            $this->router->post('shop/dynamic/remove', StoreDynamicController::class . '@remove');
            $this->router->post('shop/rate', StoreRateController::class . '@rate');
            $this->router->post('shop/rate/create', StoreRateController::class . '@create');
            $this->router->post('shop/rate/edit', StoreRateController::class . '@edit');
            $this->router->post('shop/rate/list', StoreRateController::class . '@list');
