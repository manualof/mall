                ...
                <div class="menu-content">
                    <div class="clearfix menu-box pull-left">
                        <ul class="recommend clearfix">
                            <li v-for="goods in menu.recommend"><router-link to="/search">{{ goods.name }}</router-link></li>
                        </ul>
                        <div class="content-list" v-for="item in menu.secondMenu">
                            <h5>{{ item.name }}</h5>
                            <ul class="row">
                                <li v-for="product in item.products"><router-link to="/search">{{ product.product }}</router-link><span>|</span></li>
                            </ul>
                        </div>
                    </div>
