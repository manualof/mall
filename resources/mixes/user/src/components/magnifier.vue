<template>
    <div id="magnifier" :style="{'left':wrapX + 'px','top':wrapY + 'px'}">
        <div id="smallBox" :style="{'width':boxWidth + 'px','height':boxHeight + 'px'}">
            ...
            <div id="floatBox"
                 :style.sync="{'left':floatBoxLeft + 'px','top':floatBoxTop + 'px','width':floatBoxWidth + 'px','height':floatBoxHeight + 'px'}"
                 v-show='show'></div>
        ...
        <div id="bigBox" :style="{'width':boxWidth + 'px','height':boxHeight + 'px','left':bigBoxLeft+'px'}"
            ...
            <img id="bigImg"
                 :style.sync="{'left':bigImgLeft + 'px','top':bigImgTop + 'px','width':bigImgWidth + 'px','height':bigImgHeight + 'px'}"
                 :src="imgSrc">
        </div>
    </div>
</template>
