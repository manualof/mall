            ...
            <tabs value="name1">
                <tab-pane label="品牌管理" name="name1">
                    <div class="prompt-box">
                        <p>提示</p>
                        <p>当店主添加商品时可选择商品品牌，用户可根据品牌查询商品列表被推荐品牌，将在前台品牌推荐模块显示</p>
                    ...
                    <i-table highlight-row :columns="brandColumns" :context="self" :data="brandData" ref="brand"></i-table>
                </tab-pane>
                <tab-pane label="待审核" name="name2"></tab-pane>
            </tabs>
        </div>
    </div>
</template>